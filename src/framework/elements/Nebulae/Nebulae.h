...
struct Billboards
{
	Billboards()
	{
		...
		pAttr = geo->getAttr( "P" );
		oAttr = base::Attribute::createV3f();
...
public:
	...
	base::GeometryPtr                                                                        getParticleGeometry();
	...
	base::Shader::Ptr                                                                               m_particleShader; // renders particle (uses particleTex in fragment shader and particlePositionsTex in vertex shader)
	base::Texture2dPtr                                                                               m_particleTex; // particle bilboard (blob) for rendering each particle

	BillboardsPtr                                                                                     m_billboards;
	base::Shader::Ptr                                                                              m_billboardShader;

...
TFEWidget::TFEWidget(VolumeWrapper::Ptr volume, QWidget* pParent) :
	QGroupBox(pParent),
	m_MainLayout(),
	m_TopLeftLayout(),
	m_TopLayout(),
...
//	QObject::connect(&gTransferFunction, SIGNAL(Changed()), this, SLOT(OnUpdateGradients()));
	...
	m_Canvas.SetHistogram(volume->getHistogram());
}

//void TFEWidget::OnRenderBegin(void)
//{
//	//m_Canvas.setEnabled(true);
//	//m_Canvas.SetHistogram(gHistogram);
//}

//void TFEWidget::OnRenderEnd(void)
//{
//	//m_Canvas.setEnabled(false);
//	//m_Canvas.SetHistogram(QHistogram());
//}

//void TFEWidget::OnUpdateGradients(void)
//{

...
namespace base
{
	...
	std::map<int, int> Application::m_baseToSysKey;
	Application::AppInitializer Application::m_initializer;

	Application::AppInitializer::AppInitializer()
	{
		m_baseToSysKey[KEY_LEFT]     = VK_LEFT;
		m_baseToSysKey[KEY_RIGHT]    = VK_RIGHT;
		m_baseToSysKey[KEY_UP]       = VK_UP;
		m_baseToSysKey[KEY_PGUP]     = VK_PRIOR;
		m_baseToSysKey[KEY_PGDOWN]   = VK_NEXT;
		m_baseToSysKey[KEY_DOWN]     = VK_DOWN;

		m_baseToSysKey[KEY_ESCAPE]   = VK_ESCAPE;
		m_baseToSysKey[KEY_RETURN]   = VK_RETURN;

		m_baseToSysKey[KEY_SPACE]    = VK_SPACE;
		m_baseToSysKey[KEY_RSHIFT]   = VK_RSHIFT;
		m_baseToSysKey[KEY_RCONTROL] = VK_RCONTROL;
		m_baseToSysKey[KEY_LSHIFT]   = VK_LSHIFT;
		m_baseToSysKey[KEY_LCONTROL] = VK_LCONTROL;
		m_baseToSysKey[KEY_1]        = '1';
		m_baseToSysKey[KEY_2]        = '2';
		m_baseToSysKey[KEY_3]        = '3';
		m_baseToSysKey[KEY_4]        = '4';
		m_baseToSysKey[KEY_5]        = '5';
		m_baseToSysKey[KEY_6]        = '6';
		m_baseToSysKey[KEY_7]        = '7';
		m_baseToSysKey[KEY_8]        = '8';
		m_baseToSysKey[KEY_9]        = '9';
		m_baseToSysKey[KEY_0]        = '0';
		for( int i=KEY_A; i<=KEY_Z; ++i )
			m_baseToSysKey[i] = 'A'+i-KEY_A;
	}
	...
	{
		return (GetAsyncKeyState(m_baseToSysKey[key]) & 0x8000)!=0; // 0x8000 -> KEY_DOWN
	}
